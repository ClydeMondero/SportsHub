<?php
    ...
    $select_query = 'select `product_id`, `product_name`, `product_category`, `product_sport`, `product_image`,`product_price` from `tbproducts` where product_sport = "Tennis" and product_stocks != 0';
